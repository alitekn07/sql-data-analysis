...
The project focuses on **practical business intelligence use cases**, clean SQL logic, and clear analytical outputs suitable for a **junior–mid level Business Intelligence / Data Analyst role**.
